...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/mission.php" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Our Mission</a>
  ...
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      ...
      <p>Now you are on the mission page.</p>
      </div>
      <!-- /End replace -->
    </div>
  </main>
